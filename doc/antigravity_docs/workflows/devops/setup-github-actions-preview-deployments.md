...
[View more MCP servers →](/mcp)[![DeployHQ](https://deployhq.com/assets/favicon-357ebe39b58f28869358da83948e76e7cadfb0791c97af34abfe346f5e3ef634.png)
### DeployHQ
...
Official Jenkins MCP Server plugin enabling AI assistants to manage builds, check job statuses, retrieve logs, and integrate with CI/CD pipelines through standardized MCP interface.](/mcp/jenkins)[![Thirdweb](https://thirdweb.com/favicon.ico)
### Thirdweb

Official

Read/write to over 2k blockchains, enabling data querying, contract analysis/deployment, and transaction execution, powered by [Thirdweb](https://thirdweb.com/)](/mcp/thirdweb)
### Take It Further
